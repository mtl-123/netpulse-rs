...
fn init_logging() {
    ...
    // ✅ 使用 ChronoLocal 格式化时间（需要 tracing-subscriber 启用 chrono 特性）
...
async fn main() {
    ...
    let monitor_loop = async {
        ...
        loop {
            ...
            for (_group_name, failed_list) in &group_failures {
